...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Elaina@zyilin98.onmicrosoft.com',
  ...
  title: "Elaina's Public Resource",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/oneindex-public/',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/GreyElaina',
    }
  ],
